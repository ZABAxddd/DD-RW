...
## 🛑 Notas de Desarrollo y Advertencias para el Jugador

Para mantener la pureza de la experiencia, las mecánicas exactas permanecen clasificadas. Sin embargo, los desarrolladores deben tener en cuenta las siguientes directrices de diseño implementadas en los scripts:
